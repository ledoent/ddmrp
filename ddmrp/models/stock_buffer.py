...
class StockBuffer(models.Model):
    ...
    group_id = fields.Many2one(
        ...
        string="Reference",
        copy=False,
        help="Moves created through this buffer will be tagged with this "
        "reference. If none is given, the moves generated by stock rules "
    ...
    def _prepare_procurement_values(
        ...
        return {
            ...
            "reference_ids": group or self.group_id,
        }
